  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-lg p-8 w-full max-w-md shadow-lg z-10 transform transition-transform duration-500">
        <h1 className="text-2xl font-bold mb-8 text-gray-800 text-center animate__animated animate__fadeIn sm:text-3xl">Login to Your Account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="relative">
            <input
              ...
              className={`w-full px-4 py-2 border rounded-lg text-gray-700 transition-transform duration-300 transform focus:border-cyan-500 focus:ring-2 focus:ring-cyan-400 ${focusedInput === 'email' ? 'border-cyan-500 ring-2 ring-cyan-400' : 'border-gray-300'}`}
          ...
          <div className="relative">
            <input
              ...
              className={`w-full px-4 py-2 border rounded-lg text-gray-700 transition-transform duration-300 transform focus:border-cyan-500 focus:ring-2 focus:ring-cyan-400 ${focusedInput === 'password' ? 'border-cyan-500 ring-2 ring-cyan-400' : 'border-gray-300'}`}
        ...
        <div className="flex flex-col items-center mt-6">
          <a onClick={()=>{navigate("/forgotPassword")}} className="text-blue-500 text-base hover:underline transition-colors duration-300 cursor-pointer">Forgot password?</a>
        </div>
        <div className="flex flex-col items-center mt-4">
          <a onClick={()=>{navigate("/admin/login")}} className="text-blue-500 text-sm mb-3 hover:underline transition-colors duration-300 hover:cursor-pointer">Are you an <b>Admin</b>?</a>
        </div>
      </div>
    </div>
  );
