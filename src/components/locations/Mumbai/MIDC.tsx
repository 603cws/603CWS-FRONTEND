...
const Webpage = () => {
    ...
    return (
        <div className="font-sans">
            ...
            {/* Hero Section */}
            <div className='pt-16'>
                <section className="relative h-screen lg:h-[600px] flex items-center text-center justify-center bg-cover bg-center bg-no-repeat bg-gray-100" style={{ backgroundImage: `url(${gallery2})` }}>
                    <div className="absolute inset-0 bg-black opacity-50"></div>
                    <div className="relative z-10">
                        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white drop-shadow-lg">27MIDC, Andheri East</h1>
                        <p className="text-lg text-gray-200 mt-4">603 The Co Working Space, Andheri East MIDC</p>
                    </div>
                </section>
