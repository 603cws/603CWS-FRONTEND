        ...
        >
          ...
          <div className="relative z-10">
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white drop-shadow-lg">
              Marathon Innova Lower Parel
            </h1>
            <p className="text-lg text-gray-200 mt-4">
              603 The Co Working Space, Marathon Lower Parel
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-gradient-to-r from-yellow-100 to-gray-100 flex flex-col lg:flex-row justify-between items-start px-8 lg:px-32">
          <div className="lg:w-3/5">
            ...
            <p className="leading-relaxed text-gray-700 mb-6 mx-auto text-justify">
              Marathon Centre is based in Lower Parel which is famous for being
              an entertainment and commercial hub. Lower Parel is one
            ...
            <p className="leading-relaxed text-gray-700 mb-6 mx-auto text-justify">
              ...
              to travel easily by rail and bus. Lower Parel and Currey Road
              station is at 5 minutes walking distance. If you are sociable, you
              can find several restaurants, food joints and gaming zone in the
              proximity. Palladium mall is at 5 minutes distance which has a
              multiplex, 5-star restaurants, four levels of exclusive shopping
              area.
            </p>
            <p className="leading-relaxed text-gray-700">
              ...
              distance from Marathon centre. You can find many renowned
