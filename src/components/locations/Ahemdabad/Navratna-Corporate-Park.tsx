...
const Webpage = () => {
  const [source] = useState(
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3672.4198362675966!2d72.54141621502953!3d23.0380540849331!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e84fb84b1a041%3A0xc1d6c6a5a1b9b5a3!2sNavratna%20Corporate%20Park!5e0!3m2!1sen!2sin!4v1721254426295!5m2!1sen!2sin",
  );
  ...
  const name = "Navratna Corporate Park, Ahmedabad";
  ...
  return (
    <div className="font-sans">
      ...
      <div className="pt-16">
        <section
          className="relative h-screen lg:h-[600px] flex items-center justify-center text-center bg-cover bg-center bg-no-repeat bg-gray-100"
        ...
        >
          ...
          <div className="relative z-10">
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white drop-shadow-lg">
              Navratna Corporate Park, Ahemdabad
            </h1>
            <p className="text-lg text-gray-200 mt-4">
              603 The Co Working Space, Ahemdabad
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-gradient-to-r from-yellow-100 to-gray-100 flex flex-col lg:flex-row justify-between items-start px-8 lg:px-32">
          <div className="lg:w-3/5">
            ...
            <p className="leading-relaxed text-gray-700 mb-6 mx-auto text-justify">
              ...
              state-of-the-art facility offers a dynamic and innovative
              environment designed to foster productivity and collaboration. Our
              Ahmedabad office space is equipped with modern amenities and
              cutting-edge technology, ensuring a seamless working experience
              for all our members. Navratna Corporate Park is one of Ahmedabad's
              most prestigious business hubs Situated in the heart of the city,
              the office space is easily accessible from major residential and
              commercial areas. A range of nearby amenities including
              restaurants, cafes, gyms, and retail outlets, providing
              convenience for your daily needs. Surrounded by landscaped gardens
              and green spaces, promoting a serene and pleasant working
              environment. Discover a place where productivity meets innovation
