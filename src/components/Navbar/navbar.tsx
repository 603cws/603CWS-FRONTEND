  ...
  return (
    <>
      <div
        ...
        className="bg-white navbar font-sans text-lg leading-8 tracking-normal text-gray-700 w-screen fixed border-b-2 border-yellow-400   z-50 flex items-center  font-medium backdrop-filter backdrop-blur-md  lg:pl-20 lg:pr-10 "
      >
        {/* mobile version  */}
        <div>
