                    ...
                    <div className='pt-9'>
                        ...
                        <section className="relative text-center py-24 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${gallery3})` }}>
                            ...
                            <div className="relative z-10 max-w-3xl mx-auto">
                                <h1 className="text-5xl font-semibold text-white drop-shadow-lg">603 Lodha Supremus Center (Thane)</h1>
                            </div>
                        </section>
                            ...
                            <div className="max-w-6xl mx-auto px-6">
                                <div className="grid grid-cols-2 md:grid-cols-5 gap-12 text-center">
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-lg font-medium text-gray-700">2500 Sq.ft Total Area</p>
                                    </div>
                                    <div className="space-y-4">
                                        <FaChair size={50} className="text-yellow-500 mx-auto" />
                                        <p className="text-lg font-medium text-gray-700">Seating Capacity 75</p>
                                    </div>
                                    <div className="space-y-4">
                                        <FaDesktop size={50} className="text-yellow-500 mx-auto" />
                                        <p className="text-lg font-medium text-gray-700">45 Workstations</p>
                                    </div>
                                    <div className="space-y-4">
                                        <FaDoorClosed size={50} className="text-yellow-500 mx-auto" />
                                        <p className="text-lg font-medium text-gray-700">7 Private Cabins</p>
                                    </div>
                                    <div className="space-y-4">
                                        <MdMeetingRoom size={50} className="text-yellow-500 mx-auto" />
                                        <p className="text-lg font-medium text-gray-700">2 Meeting Rooms</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="max-w-6xl mx-auto py-16 px-6 ">
                            ...
                            <div className="text-center mt-16">
                                <button
                                    ...
                                    className="bg-yellow-500 text-white py-3 px-8 rounded-full text-lg font-medium hover:bg-yellow-600 transition-colors duration-300 shadow-lg"
                                >
                                    Take a Walkthrough
                                </button>
