    ...
    <>
      <div className="font-sans bg-gray-50 w-full">
        ...
        <div className="pt-9">
          {/* Hero Section */}
          <section
            className="relative text-center py-24 bg-cover bg-center bg-no-repeat h-screen lg:h-[400px] flex items-center justify-centers"
            style={{ backgroundImage: `url(${gallery3})` }}
          >
            <div className="absolute inset-0 bg-black opacity-70"></div>
            <div className="relative z-10 max-w-3xl mx-auto">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-white drop-shadow-lg">
          ...
          <section className="bg-white py-16 px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-lg lg:text-xl text-gray-600 mt-6 leading-relaxed text-justify">
                ...
                modern amenities, it’s designed to cater to all your business
                needs.
              </p>
            </div>
          </section>
          ...
          <div className="max-w-6xl mx-auto py-16 px-6 ">
            ...
            <div className="text-center mt-16">
              <button
                onClick={() =>
                  window.open(
                    "https://neo.foyr.com/toolv2/magiktour/index.html?view=652141696a4ba18d1a61a4f2",
                    "_blank",
                  )
                }
