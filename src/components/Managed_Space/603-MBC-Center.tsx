            ...
            <div className='pt-9'>
                ...
                <section className="relative text-center py-24 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${gallery3})` }}>
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        <h1 className="text-5xl font-semibold text-white drop-shadow-lg">603 MBC Center
                            (Thane)</h1>
                    </div>
                </section>
                    ...
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-12 text-center">
                            <div className="space-y-4">
                                ...
                                <p className="text-lg font-medium text-gray-700">9600 Sq.ft Total Area</p>
                            </div>
                            <div className="space-y-4">
                                <FaChair size={50} className="text-yellow-500 mx-auto" />
                                <p className="text-lg font-medium text-gray-700">Seating Capacity 250</p>
                            </div>
                            <div className="space-y-4">
                                <FaDesktop size={50} className="text-yellow-500 mx-auto" />
                                <p className="text-lg font-medium text-gray-700">150 Workstations</p>
                            </div>
                            <div className="space-y-4">
                                <FaDoorClosed size={50} className="text-yellow-500 mx-auto" />
                                <p className="text-lg font-medium text-gray-700">10 Private Cabins</p>
                            </div>
                            <div className="space-y-4">
