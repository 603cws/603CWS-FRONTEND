...
const eventsData = [
  {
    ...
    description:
      "A lively open mic session for registered participants showcasing talents like music, poetry, and comedy.",
    imageUrl:
      "https://res.cloudinary.com/dhz6meh4y/image/upload/q_10/v1566471317/613A3152.jpg",
    detailedDescription:
  ...
  },
  {
    ...
    description:
      "Hands-on UI/UX workshop conducted by Design Wings, fostering creativity and practical learning.",
    imageUrl:
      "https://static.wixstatic.com/media/05396d_9fecb868b95245b8814151eb839c0bd0~mv2.jpg/v1/fill/w_875,h_505,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/zac-wolff-7uSKXpksCKg-unsplash.jpg",
    detailedDescription:
  ...
  },
  {
    ...
    location: "603 The Coworking Space",
    description:
      "Red Bull energizes 603 employees by providing free energy drinks, creating a lively atmosphere.",
  ...
  },
  {
    ...
    description:
      "ICICI Prudential educates coworkers about the benefits of mutual fund investments.",
    imageUrl:
      "https://5.imimg.com/data5/SELLER/Default/2024/4/411397427/TO/VL/MI/61083566/icici-prudential-mutual-fund.png",
    detailedDescription:
  ...
  },
  {
    ...
    description:
      "HSBC Credit Cards offers insights into the benefits and perks of their credit card options.",
    imageUrl:
      "https://www.hsbc.co.in/content/dam/hsbc/en/images/16-9/13903-live-plus-card-01-signature-red-1-generic-2000x1125.jpg",
    detailedDescription:
  ...
  },
  {
    ...
    location: "603 The Coworking Space",
    description:
      "Employees nominate coworkers to receive a plant for their desk, fostering sustainability and community.",
    imageUrl:
      "https://i.guim.co.uk/img/media/3d87cc0c8c2d713ddc1ab73d8221bacc296ac921/0_166_4500_2700/master/4500.jpg?width=300&quality=45&auto=format&fit=max&dpr=2&s=e8418a2e4adcc87f9d7d2d0f62d13163",
    detailedDescription:
  ...
  },
  {
    ...
    location: "603 The Coworking Space",
    description:
      "Hands-on linocut printing workshop led by Artwala House, fostering creativity in a collaborative environment.",
    imageUrl:
      "https://vagabondexperiences.com/wp-content/uploads/2024/03/IMG_1027-820x520.jpg",
    detailedDescription:
  ...
  },
  {
    ...
    location: "603 The Coworking Space",
    description:
      "An immersive pottery and clay workshop fostering creativity and community engagement.",
    imageUrl:
      "https://assets-in.bmscdn.com/discovery-catalog/events/et00387646-qvnvvkqlne-landscape.jpg",
    detailedDescription:
    ...
    <div className="min-h-screen bg-gray-50 w-full">
      ...
      <div className="pt-16">
        <section className="bg-gradient-to-r from-yellow-400 to-yellow-500 py-16 text-center text-white">
          ...
          <p className="text-xl mt-4">
            Join us for engaging and exciting events tailored for coworking
            professionals.
          </p>
        </section>
        <section className="bg-gray-100 py-12 text-center">
          ...
          <button
            className="mt-6 py-3 px-8 bg-yellow-500 text-white font-semibold rounded-lg hover:bg-yellow-600"
      ...
      {isFormOpen && (
        <Dialog
          ...
          className="fixed inset-0 z-30 flex items-center justify-center bg-black bg-opacity-50 max-h-screen"
        >
          <div className="bg-white rounded-lg mx-auto p-8 w-1/3">
            ...
            <form onSubmit={handleFormSubmit}>
              <div className="mb-4">
                ...
                <input
                  type="text"
                  className="w-full px-4 py-2 border rounded-lg focus:ring-yellow-500"
                  required
                />
              </div>
              <div className="mb-4">
              ...
              <div className="text-right">
                ...
                <button
                  type="button"
                  className="ml-4 py-2 px-6 bg-gray-500 text-white font-semibold rounded-lg hover:bg-gray-600 transition"
