...
const EditUserModal: React.FC<EditUserModalProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        const response = await axios.post("http://localhost:3000/api/v1/users/admin/updateuser", { companyName, location, kyc, phone, email, role, monthlycredits, extracredits, creditsleft, id }, { withCredentials: true });
    ...
    const handleConfirmDelete = async () => {
        const response = await axios.post("http://localhost:3000/api/v1/users/admin/deleteuser", { id }, { withCredentials: true });
        console.log(response);
