...
const Calendar: React.FC<CalendarProps> = ({ value }) => {
    ...
    useEffect(() => {
        setcreditstobespent(spacetype === "meeting" ? 0.5 : spacetype === "conference" ? 1 : 0);
    }, [spacetype]);
        ...
        <div style={containerStyle}>
            ...
            {windowWidth > 684 && (
                <>
                    <div style={legendStyle}>
                        ...
                        <div style={legendItemStyle}>
                            <div style={{ ...legendColorBoxStyle, ...partiallyBookedStyle }}></div>
                            <span>Weekends</span>
                        </div>
                        <div style={legendItemStyle}>
            ...
            <form style={formStyle}>
                <div style={inputContainerStyle}>
                    ...
                    <input type="text" value={selectedLocation} style={{ ...inputStyle, cursor: 'not-allowed', backgroundColor: '#f0f0f0' }} readOnly />
                </div>
                <div style={inputContainerStyle}>
                    <label style={labelStyle}>Selected Date:</label>
                    <input type="text" value={selectedDate} style={{ ...inputStyle, cursor: 'not-allowed', backgroundColor: '#f0f0f0' }} readOnly />
                </div>
                {selectedDate != '' && (<><div style={inputContainerStyle}>
                    <label style={labelStyle}>Company Name:</label>
                    <input type="text" value={companyName} onChange={(e) => setcompanyName(e.target.value)} style={inputStyle} />
                </div>
                    <div style={inputContainerStyle}>
                        <label style={labelStyle}>Email:</label>
                        <input type="email" value={email} style={{ ...inputStyle, cursor: 'not-allowed', backgroundColor: '#f0f0f0' }} readOnly />
                    </div>
                    <div style={inputContainerStyle}>
                    ...
                    <button
                        ...
                        style={(selectedStartTime && selectedEndTime && companyName && email && selectedDay) ? sendbuttonStyle : disabledButtonStyle}
                        disabled={!(selectedStartTime && selectedEndTime && companyName && email && selectedDay)}
                    >
                        Book Now
                    </button></>)}
            </form>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <h4 style={{ marginTop: 30, flexGrow: 1, textAlign: 'center', fontSize: "20px" }}><b>Booking confirmed successfully!</b></h4>
                            </div>
                            <p style={{ textAlign: 'center', marginBottom: "30px", paddingTop: "20px" }}>
                                Kindly check your inbox for comprehensive details regarding your booking.</p>
                        </div>
                    </div>
                )
            }
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <h4 style={{ flexGrow: 1, textAlign: 'center', fontSize: "20px" }}><b>Not Enough Credits!</b></h4>
                                <MdClose onClick={() => { setnotenoughcredits(false) }} style={{
                                    cursor: 'pointer',
                            ...
                            <p style={{ textAlign: 'center', marginBottom: "30px", paddingTop: "20px" }}>
                                As the duration of your stay exceeds the allocated credits, any additional hours for the booked room will be reflected in your total bill.</p>
                            <p style={{ textAlign: 'center', marginBottom: "30px", paddingTop: "20px" }}>
                                Do you really want to confirm the booking?</p>
                            <div style={{
                                display: 'flex',
                                justifyContent: 'center',
                                gap: '40px',
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <h4 style={{ flexGrow: 1, textAlign: 'center', fontSize: "20px" }}><b>Confirm Booking</b></h4>
                                <MdClose onClick={() => { setconfirm(false) }} style={{
                                    cursor: 'pointer',
                                    transition: 'transform 0.2s ease',
                                    position: 'absolute',
                                    right: '16px',
