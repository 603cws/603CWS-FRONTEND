    ...
    return (
        <div className="font-sans bg-gray-50 w-screen overflow-x-hidden">
            ...
            <div
                ...
                className="relative bg-no-repeat bg-cover bg-fixed mb-5"
            >
                <div className="absolute inset-0 bg-black opacity-50"></div> {/* Dark overlay */}
                <div className="relative flex justify-center items-center h-[600px] w-full">
                    <div className="text-center px-12 py-16">
                        <h2 className="text-white text-6xl font-semibold mb-4">Privacy Policy</h2>
                        <p className="text-white text-2xl">Please read it carefully</p>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto px-6 md:px-12 overflow-auto">
                <div className="max-w-4xl mx-auto p-6 sm:p-10 text-gray-800">
                    ...
                    <p className="mb-4">
                        ...
                        <a href="https://www.603thecoworkingspace.com" className="text-blue-600 underline ml-1">https://www.603thecoworkingspace.com</a>,
                        one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of
                        information that is collected and recorded by 603TheCoworkingSpace and how we use it.
                    </p>
                    ...
                    <p className="mb-4">
                        ...
                        to the information that they shared and/or collected in 603TheCoworkingSpace. This policy is not applicable to
                        any information collected offline or via channels other than this website.
                    </p>

                    <p className="mb-4">
                        Our Privacy Policy was created with the help of the TermsFeed Free Privacy Policy Generator.
                    </p>

                    <h2 className="text-2xl font-semibold mt-10 mb-3">Consent</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">Log Files</h2>
                    <p className="mb-4">
                        603TheCoworkingSpace follows a standard procedure of using log files. These files log visitors when they
                        visit websites. All hosting companies do this and a part of hosting services' analytics. The information
                        collected by log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP),
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">Cookies and Web Beacons</h2>
                    <p className="mb-4">
                        Like any other website, 603TheCoworkingSpace uses 'cookies'. These cookies are used to store information
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">Advertising Partners Privacy Policies</h2>
                    <p className="mb-4">
                        You may consult this list to find the Privacy Policy for each of the advertising partners of 603TheCoworkingSpace.
                    </p>

                    <p className="mb-4">
                        Third-party ad servers or ad networks use technologies like cookies, JavaScript, or Web Beacons that are used in
                        their respective advertisements and links that appear on 603TheCoworkingSpace, which are sent directly to users' browsers.
                    ...
                    <p className="mb-4">
                        Note that 603TheCoworkingSpace has no access to or control over these cookies that are used by third-party advertisers.
                    </p>

                    <h2 className="text-2xl font-semibold mt-10 mb-3">Third Party Privacy Policies</h2>
                    <p className="mb-4">
                        603TheCoworkingSpace's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">Do Not Sell My Personal Information</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">GDPR Data Protection Rights</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl font-semibold mt-10 mb-3">Children's Information</h2>
                    <p className="mb-4">
                    ...
                    <p className="mb-4">
                        603TheCoworkingSpace does not knowingly collect any Personal Identifiable Information from children under the age of 13.
