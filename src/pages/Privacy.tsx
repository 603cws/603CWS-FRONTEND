      ...
      <div className="container mx-auto px-6 md:px-12 overflow-auto">
        <div className="max-w-4xl mx-auto p-6 sm:p-10 text-gray-800">
          <p className="mb-4">
            ...
            collected and recorded by 603TheCoworkingSpace and how we use it.
          </p>
          ...
          <p className="mb-4">
            ...
            that they shared and/or collected in 603TheCoworkingSpace. This
            policy is not applicable to any information collected offline or via
            channels other than this website.
          </p>

          <p className="mb-4">
            Our Privacy Policy was created with the help of the TermsFeed Free
          ...
          <p className="mb-4">
            603TheCoworkingSpace follows a standard procedure of using log
          ...
          <p className="mb-4">
            Like any other website, 603TheCoworkingSpace uses 'cookies'. These
          ...
          <p className="mb-4">
            ...
            advertising partners of 603TheCoworkingSpace.
          </p>

          <p className="mb-4">
            Third-party ad servers or ad networks use technologies like cookies,
            JavaScript, or Web Beacons that are used in their respective
            advertisements and links that appear on 603TheCoworkingSpace, which
          ...
          <p className="mb-4">
            Note that 603TheCoworkingSpace has no access to or control over
          ...
          <p className="mb-4">
            603TheCoworkingSpace's Privacy Policy does not apply to other
          ...
          <p className="mb-4">
            603TheCoworkingSpace does not knowingly collect any Personal
